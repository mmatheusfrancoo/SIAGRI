...
uses
  ...
  Datasnap.DSHTTP, IdBaseComponent, IdComponent, IdIOHandler, IdIOHandlerStream,
  Datasnap.DSHTTPServiceProxyDispatcher, System.JSON, Data.DBXCommon, IdContext;
...
procedure TWebModule1.OnContextCreated(AContext: TIdContext);
begin
   //AContext.Connection.IOHandler.MaxLineLength := 999999999;
   AContext.Connection.IOHandler.MaxLineLength := 512 * 1024; //setting MaxLinelength to 20 MB
end;

procedure TWebModule1.DSServerClass1GetClass(DSServerClass: TDSServerClass; var PersistentClass: TPersistentClass);
begin
  PersistentClass := ServerMethodsUnit.TSM;
end;
...
begin
  if SameText(TagString, 'urlpath') then
    ...
    ReplaceText := ServerMethodsUnit.TSM.ClassName
